...
\StringTok{  }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{%in%}\StringTok{ }\NormalTok{country_list) }\OperatorTok{%>%}
...
\begin{center}\includegraphics[width=0.7\linewidth]{01-dayone_files/figure-latex/plot-yearly-yes-1} \end{center}
...
\begin{Highlighting}[]
\NormalTok{un_votes }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"United States of America"}\NormalTok{, }\StringTok{"Turkey"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{inner_join}\NormalTok{(un_roll_calls, }\DataTypeTok{by =} \StringTok{"rcid"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{center}\includegraphics[width=0.7\linewidth]{01-dayone_files/figure-latex/plot-yearly-yes-issue-1} \end{center}
