...
In this assignment we analyze data from the 2016 GSS, using it to estimate values of population parameters of interest about US adults.[^hw-07-exploring-gss-1]

[^hw-07-exploring-gss-1]: Smith, Tom W, Peter Marsden, Michael Hout, and Jibum Kim.
...
Go to the course GitHub organization and locate your homework repo, which should be named `hw-07-exploring-gss-YOUR_GITHUB_USERNAME`.
