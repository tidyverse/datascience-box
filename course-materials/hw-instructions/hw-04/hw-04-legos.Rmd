...
Go to the course GitHub organization and locate your homework repo, which should be named `hw-04-legos-YOUR_GITHUB_USERNAME`.
...
We'll use the **tidyverse** package for the analysis and the **fivethirthyeight** package for data.
