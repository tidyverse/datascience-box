...
Go to the course GitHub organization and locate your homework repo, which should be named `hw-03-college-majors-YOUR_GITHUB_USERNAME`.
...
We'll use the **tidyverse** package for the analysis, the **scales** package for formatting numeric values, and the **fivethirthyeight** package for data.
...
The data can be found in the **fivethirthyeight** package, and it's called `college_recent_grads`.
