...
```{r grassmarket, fig.margin = TRUE, echo = FALSE, fig.width=3, fig.cap="Photo by Clark Van Der Beken on Unsplash"}
...
Go to the course GitHub organization and locate your homework repo, which should be named `hw-02-accidents-YOUR_GITHUB_USERNAME`.
