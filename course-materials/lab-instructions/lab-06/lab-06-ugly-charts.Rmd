...
- If you both changed the same part of a file, git will produce a **merge conflict** because it doesn't know how which change to you want to keep and which change you want to overwrite.
