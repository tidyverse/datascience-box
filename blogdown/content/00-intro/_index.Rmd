...
This is a place for organizing materials for teaching (and learning) data 
science with R, RStudio, the tidyverse and tidyverse friendly packages. It's 
called __Data Science Course in a Box__, as it contains all the materials you 
(an educator) might need to teach data science or you (a learner) might find 
...
<i class="fas fa-tv fa-fw"></i> **slides**: 25 slide decks, each to be covered 
roughly in a 75 minute class session.  
<i class="fas fa-file-alt fa-fw"></i> **assignments**: 6 homewoek assignments.  
<i class="fas fa-file-code fa-fw"></i> **labs**: 10 guided hands on exercises 
for students requiring minimal introduction from the instructor.  
<i class="fas fa-edit fa-fw"></i> **exams**: 2 sample take-home exams and keys.  
<i class="fas fa-folder-open fa-fw"></i> **project**: Final project assignment.  
<i class="fas fa-hand-point-up fa-fw"></i> **tutorials** (WIP): Interactive 
learning exercises built with `learnr`.  
<i class="fas fa-toolbox fa-fw"></i> **infrastructure** (WIP):information on the 
computing infrastructure of this course and is designed for teachers, while the 
remainder of the content is for teachers and learners. Specifically it covers:
