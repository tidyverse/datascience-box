...
topic_flow <- create_graph() %>%
  ...
  add_node(
    ...
    node_aes = node_aes(
      ...
      color = welcome_border, penwidth = 2, fillcolor = welcome_fill
    )
  ) %>%
  # Exploring data ----
  add_node(
...
**Unit 1 - Welcome:** This unit is an introduction to the content, pedagogy, and toolkit of the course.
