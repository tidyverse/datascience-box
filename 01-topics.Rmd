...
topic_flow <- create_graph() %>%
  ...
  add_node(
    ...
    node_aes = node_aes(
      ...
      color = "#384742", penwidth = 2, fillcolor = "#b6e4d5"
    )
  ) %>%
  add_edge(
    from = "Exploring\ndata", to = "Data\nscience\nethics",
  ...
  add_node(
    ...
    node_aes = node_aes(
      x = 4, y = 1,
      fontsize = 10, width = 0.75,
      color = "#b6e4d5", penwidth = 2, fillcolor = "white"
    )
  ) %>%
  add_node(
    label = "Data\nprivacy",
...
**Unit 2 - Data science ethics:** In this unit we discuss misrepresentation of findings, particularly in data visualisations, breaches of data privacy, and algorithmic bias.

**Unit 3 - Making rigorous conclusions:** In this unit we introduce modelling and statistical inference for making data-based conclusions.
...
**Unit 4 - Looking forward:** In the last unit we present a series of modules such as interactive reporting and visualization with Shiny, text analysis, and Bayesian inference.
